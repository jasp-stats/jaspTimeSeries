...
test_that("Coefficients table results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(
      "TRUE", 0.054896748258671, "MA(1)", -0.384412851213784, -0.492491170956408,
...
test_that("Model Summary table results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(
      3278.28528217595, 3278.59754983394, 3300.00768737026, -1633.14264108798,
      8187.159216112
    )
  )
})
...
test_that("Coefficients table results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(
      "TRUE", 3.39005881784864, "Drift", 7.68963795029409, 1.01543824842242,
...
test_that("Forecasts table results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(
      2623.5974678915, 2450.52090896614, 278, 3277.49627292311, 3450.57283184846,
...
test_that("Model Summary table results match", {
  ...
  jaspTools::expect_equal_tables(
    table,
    list(
      3860.19374839746, 3860.50601605545, 3881.91615359176, -1924.09687419873,
      64928.1574797458
    )
  )
})
